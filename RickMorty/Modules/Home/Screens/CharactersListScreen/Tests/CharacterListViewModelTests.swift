...
@testable import LocalPersistanceMock
 ...
 final class CharacterListViewModelTests: XCTestCase {
     ...
     func makeSUT(
         coreDataService: any LocalServiceProtocol = MockCoreDataService(),
         characterDataUseCase: any CharactersListUseCaseProtocol = MockCharactersListUseCase()
     ) -> CharacterListViewModel {
         let sut = withDependencies {
             $0.localService = coreDataService
